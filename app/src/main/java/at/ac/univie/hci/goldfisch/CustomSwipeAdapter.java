...
/**
 * Created by Snezana on 07/05/2017.
 */

public class CustomSwipeAdapter extends PagerAdapter {
    private int [] getraenke_fotos = {R.drawable.wasserglas, R.drawable.juicewithoutbackround, R.drawable.coffeeeewithoutback, R.drawable.martini3};
